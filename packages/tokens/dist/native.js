...
exports.nativeTokens = {
    ...
    gradients: {
        ...
        deepspace: gradients_1.gradients.deepspace.native,
        deepspaceHover: gradients_1.gradients.deepspaceHover.native,
        greenEmerald: gradients_1.gradients.greenEmerald.native,
        blueCyan: gradients_1.gradients.blueCyan.native,
        blueTeal: gradients_1.gradients.blueTeal.native,
        purplePink: gradients_1.gradients.purplePink.native,
        violetPurple: gradients_1.gradients.violetPurple.native,
        pinkViolet: gradients_1.gradients.pinkViolet.native,
        cyanTeal: gradients_1.gradients.cyanTeal.native,
        tealEmerald: gradients_1.gradients.tealEmerald.native,
        emeraldCyan: gradients_1.gradients.emeraldCyan.native,
        yellowGreen: gradients_1.gradients.yellowGreen.native,
        blues: gradients_1.gradients.blues.native,
        violetPurpleLight: gradients_1.gradients.violetPurpleLight.native,
        blueCyanLight: gradients_1.gradients.blueCyanLight.native,
        pinkOrange: gradients_1.gradients.pinkOrange.native,
        greenCyanBlue: gradients_1.gradients.greenCyanBlue.native,
        gray: gradients_1.gradients.gray.native,
