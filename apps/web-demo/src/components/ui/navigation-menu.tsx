...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-light-blue/20 hover:text-light-blue focus:bg-light-blue/20 focus:text-light-blue focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-light-blue/20 data-[state=open]:bg-light-blue/20 text-white-secondary"
)
